...
<body>
    <h1 class="demoInputBox">List Member</h1>
    <div class = "heading-title">
       <button> <a href="/member/create">Add Member</a></button> <br />
    </div>
    <table border="1">
          <thead class="demoInputBox">
            ...
            <td><?php echo $d->email ?></td>
             <td><img height="50px" width="50px" src="image/member/<?php echo $d->image;?>"></td>
            ...
            <td><a href="delete.member.php?id=<?php echo $d->id?>"
                 onclick ="return confirm('are you sure to delete?')"><span style="color:red">Delete</a>
                <a href="edit_member.php?id=<?php echo $d->id?>"><span style="color:green">Edit</a></td>
                        </tr>
                    <?php }?>
        </tbody>
        </table>
